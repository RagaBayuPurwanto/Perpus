...
<head>
    ...
    <body>
			...
			if(isset($_POST['input'])){
				...
				$cek = mysqli_query($koneksi, "SELECT * FROM guru WHERE nama='$nama'");
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($koneksi, "INSERT INTO guru(nama, alamat, nohp)
															VALUES($nama', '$alamat', '$nohp')") or die(mysqli_error());
						if($insert){
            ...
            <center><div class="panel panel-info" style="width: 500px;">
                        ...
                        <h3 class="panel-title"><i class="icon-user"></i>Input Data Pengunjung</h3> 
                        </div>
                        <div class="panel-body">
                         <form name="form1" id="form1" class="form-horizontal row-fluid" action="?page=guru_input" method="POST" >
										...
										<div align="left" class="control-group">
											...
											<div class="controls">
												<input type="text" name="nama" id="nama" placeholder="Nama" class="form-control span8 tip" required>
											</div>
										</div>
...
<br
        ...
        <div class="footer span-12">
            <div class="container">
              <center> <b class="copyright"><a href=""> Perpustakaan Desa "TUNAS BANGSA" </a> &copy; 2019 </b></center>
            </div>
        </div>
        <script>
