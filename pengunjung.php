...
<link rel="icon" type="image/ico" href="icon.ico">
    <meta charset="UTF-8">
    <title>Perpustakaan Desa "TUNAS BANGSA"</title>
    ...
    <div class="container-fluid"> <!-- Main content -->
		...
		<b>Selamat Datang di Perpustakaan Desa "TUNAS BANGSA", Untuk Login Admin silahkan klik <a href="login_user.php">here</a></b>
          </div>
                    ...
                    <div class="twt-area">
                        <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-pengunjung.php"  method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <textarea rows="1.5" name="saran" id="saran" class="form-control" placeholder="Saran Anda untuk PerpusDes" cols="25"></textarea>
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                              </div>
                          </div>
                          <div class="form-group">
